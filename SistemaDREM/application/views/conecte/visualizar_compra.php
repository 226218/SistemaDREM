            ...
            <div class="widget-content" id="printOs">
                <div class="invoice-content">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">#Venta: <span ><?php echo $result->iditeraciondocumento?></span></br> </br> <span>Fecha: <?php echo date('d/m/Y');?></span></td>
                                </tr>
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        <?php if($tipotramite != null){?>
                   
                        <table class="table table-bordered table-condensed" id="tbltipotramite" style="margin-top: 0; padding-top: 0">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($tipotramite as $p) {
                                            ...
                                            $totaltipotramite = $totaltipotramite + $p->subTotal;
                                            echo '<tr>';
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>€ <?php echo number_format($totaltipotramite,2,',','.');?></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                               <?php }?>
                        ...
                        <h4 style="text-align: right">Valor Total: € <?php echo number_format($totaltipotramite,2,',','.');?></h4>
