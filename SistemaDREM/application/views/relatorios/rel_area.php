    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a href="<?php echo base_url()?>index.php/relatorios/areaRapid"><i class="icon-user"></i> <small>Todos las Areas</small></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form action="<?php echo base_url()?>index.php/relatorios/areaCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
